    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['status', 'priority'], name='StockApp_co_status_6f9216_idx'), models.Index(fields=['submitted_by'], name='StockApp_co_submitt_834440_idx'), models.Index(fields=['department'], name='StockApp_co_departm_8846d3_idx')],
            },
        ),
        migrations.CreateModel(
            name='AvailableStock',
            fields=[
                ...
                ('purchase_price', models.DecimalField(decimal_places=2, help_text='Price at which the item was purchased', max_digits=10, verbose_name='Purchase Price')),
                ('purchase_date', models.DateField(help_text='Date when the item was purchased', verbose_name='Purchase Date')),
                ('shop_or_platform', models.CharField(help_text='Shop or online platform where the item was purchased', max_length=200, verbose_name='Shop/Platform')),
                ('invoice_number', models.CharField(blank=True, help_text='Optional invoice number for the purchase', max_length=100, null=True, verbose_name='Invoice Number')),
            ...
            options={
                ...
                'ordering': ['-date'],
                'indexes': [models.Index(fields=['status', 'department'], name='StockApp_av_status_1cea31_idx'), models.Index(fields=['item_id'], name='StockApp_av_item_id_884353_idx'), models.Index(fields=['serial_no'], name='StockApp_av_serial__4d1d19_idx')],
            },
        ),
    ]
